...
$F in N B V$],
  ...
  (
    name: [conditional probability space and trace $sigma$-algebra],
    id: "conditional-probability-space-and-trace-sigma-algebra",
    title: "conditional probability space and trace σ-algebra",
  ...
  (
    name: [continuous random vector 和 continuous joint cdf],
...
的 distribution 函数]],
  ...
  (
    name: [independence 让 conditional distribution, density 和 expectation 都退化],
...
of marginal distributions],
  ...
  (
    name: [joint distribution and joint cdf],
...
($0 < n < m < r lt.eq oo$)],
  ...
  (
    name: [measurable space and measure space],
  ...
  (
    name: [nul set, subnull set, almost everywhere],
  ...
  (
    name: [probability space, probability measure, sample space, event space],
    id: "probability-space",
    title: "probability space, probability measure, sample space, event space",
