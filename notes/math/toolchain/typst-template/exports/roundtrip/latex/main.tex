...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={The support region bounded by y equals 2x, y equals three halves minus x, and the x-axis.}]{assets/fig-joint-support.pdf}}
\caption{A joint-distribution support set.}\label{fig-joint-support}
\end{figure}
