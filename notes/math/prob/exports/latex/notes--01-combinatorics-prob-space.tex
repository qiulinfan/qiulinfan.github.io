...
如果 \(\Omega\) 是 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-measurable-space-and-measure-space}{measurable space and measure space} 意义下的一个 finite measure space, 那么对于任意 \(A_{1},\ldots,A_{n} \subseteq \Omega\) 的, 有:
...
按 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-measurable-space-and-measure-space}{measurable space and measure space} 的定义, 一个 probability space 是三元组 \((\Omega,\mathcal{F},{\mathbb{P}})\), 其中 \({\mathbb{P}}(\varnothing) = 0,{\mathbb{P}}(\Omega) = 1\).\\
