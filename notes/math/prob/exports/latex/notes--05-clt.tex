...
\begin{definition}{\protect\phantomsection\label{kn-convergence-in-distribution}{\textbf{convergence
in distribution}}}
...
\begin{definition}{\protect\phantomsection\label{kn-moment-generating-function}{\textbf{moment
generating function}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-lindeberg-levy-central-limit-theorem}{\textbf{Lindeberg-Levy
...
\begin{theorem}{\protect\phantomsection\label{kn-berry-esseen-theorem}{\textbf{Berry-Esseen
Theorem}}}
