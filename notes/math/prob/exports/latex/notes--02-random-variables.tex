...
\begin{definition}{\protect\phantomsection\label{kn-random-variable}{\textbf{random
variable}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-borel-measurable-random-variables}{\textbf{以
Borel measurable 的方式组合起多个 random variables}}}
...
\begin{definition}{\protect\phantomsection\label{kn-sigma-algebra-generated-by-a-random-variable-measurable-function}{\textbf{\(\sigma\)-algebra
generated by a random variable (measurable function)}}}
...
\begin{definition}{\protect\phantomsection\label{kn-probability-distribution}{\textbf{probability
distribution}}}
...
\begin{definition}{\protect\phantomsection\label{kn-distribution-function-cumulative-distribution-function-cdf}{\textbf{distribution
function (也称 \textbf{cumulative distribution function, cdf})}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-distribution-function}{\textbf{distribution
function 的性质}}}\label{thm-02-random-variables-distribution-function}
...
\begin{theorem}{\protect\phantomsection\label{kn-dynkins-pi-lambda-theorem}{\textbf{Dynkin's
\(\pi - \lambda\) theorem}}}
...
\begin{corollary}{\protect\phantomsection\label{kn-distribution-function-f-x-determines-distribution-mathbb-p-x}{\textbf{distribution
function \(F_{X}\) determines distribution \({\mathbb{P}}^{X}\)}}}
...
\begin{definition}{\protect\phantomsection\label{kn-discrete-random-variable}{\textbf{discrete
random variable}}}
...
\begin{definition}{\protect\phantomsection\label{kn-probability-mass-function-pmf}{\textbf{probability
mass function (pmf)}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-pmf-distribution-counting-measure-mu-s-radon-nikodym}{\textbf{pmf
是 distribution 对于 counting measure \(\mu_{S}\) 的 Radon-Nikodym
导数}}}
...
\begin{definition}{\protect\phantomsection\label{kn-continuous-random-variable}{\textbf{continuous
random variable}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-cdf-nbv}{\textbf{cdf 一定是 \(NBV\)
的}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-random-variable-continuous-random-variable}{\textbf{一个
random variable 是 continuous random variable 的充要条件}}}
...
\begin{definition}{\protect\phantomsection\label{kn-probability-density-function-pdf}{\textbf{probability
...
\begin{proposition}{\protect\phantomsection\label{kn-probability-density-function}{\textbf{probability
density function 的性质}}}
...
\begin{definition}{\protect\phantomsection\label{kn-singular-continuous-random-variable}{\textbf{singular
...
\begin{theorem}{\protect\phantomsection\label{kn-lebesgue-decomposition-theorem}{\textbf{Lebesgue
...
\begin{definition}{\protect\phantomsection\label{kn-expectation-and-variance-of-random-variable}{\textbf{expectation
...
\begin{proposition}{\protect\phantomsection\label{kn-discrete-random-variable-expectation-variance}{\textbf{discrete
random variable 的 expectation 和 variance}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-distribution-x-push-forward-measure-expectation}{\textbf{用
distribution (\(X\) 的 push-forward measure) 计算 expectation}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-continuous-random-variable-expectation-variance}{\textbf{continuous
random variable 的 expectation 和 variance}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-expectation}{\textbf{expectation
的性质}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-computing-variance}{\textbf{computing
variance}}}
...
\begin{definition}{\protect\phantomsection\label{kn-centered-square-integrable-random-variables}{\textbf{zero-centered
square integrable random variables
\(L_{0}^{2}(\Omega,\mathcal{F},{\mathbb{P}})\)}}}
...
\begin{definition}{\protect\phantomsection\label{kn-covariance}{\textbf{covariance}}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Three scatterplots with positive, negative, and zero linear covariance trends.}]{assets/notes--fig-prob-02-random-variables-diagram-01.pdf}}
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio,alt={Points on a circle show dependent variables whose covariance is zero.}]{assets/notes--fig-prob-02-random-variables-diagram-02.pdf}}
...
\begin{theorem}{\protect\phantomsection\label{kn-covariance-positive-semidefinite-bilinear-form}{\textbf{covariance
is a positive-semidefinite symmetric bilinear form}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-centered-l2-hilbert-space-under-covariance}{\textbf{\(L_{0}^{2}(\Omega,\mathcal{F},{\mathbb{P}})\)
为一个 Hilbert space, with covariance as an inner product}}}
...
\begin{definition}{\protect\phantomsection\label{kn-correlation}{\textbf{correlation}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-properties-of-correlation}{\textbf{properties
of correlation}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-random-variables-variance}{\textbf{两个
random variables 之和的 variance}}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={A stem plot of the Poisson probability mass function with lambda equal to 3.}]{assets/notes--fig-prob-02-random-variables-diagram-03.pdf}}
...
\begin{theorem}{\protect\phantomsection\label{kn-additivity-of-poisson-distribution}{\textbf{additivity
...
\begin{definition}{\protect\phantomsection\label{kn-uniform-distribution}{\textbf{uniform
distribution}}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={The uniform density is constant at 1/(b-a) between a and b and zero outside.}]{assets/notes--fig-prob-02-random-variables-diagram-04.pdf}}

\end{center}

\begin{center}

\pandocbounded{\includegraphics[keepaspectratio,alt={The uniform cumulative distribution rises linearly from zero at a to one at b.}]{assets/notes--fig-prob-02-random-variables-diagram-05.pdf}}
...
\begin{definition}{\protect\phantomsection\label{kn-exponential-distribution}{\textbf{exponential
distribution}}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={The exponential density decreases from lambda toward zero as x increases.}]{assets/notes--fig-prob-02-random-variables-diagram-06.pdf}}

\end{center}

\begin{center}

\pandocbounded{\includegraphics[keepaspectratio,alt={The exponential cumulative distribution rises from zero toward one.}]{assets/notes--fig-prob-02-random-variables-diagram-07.pdf}}
...
\begin{theorem}{\protect\phantomsection\label{kn-memoryless-property-of-exponential-distribution}{\textbf{memoryless
...
\begin{definition}{\protect\phantomsection\label{kn-gamma-distribution}{\textbf{\(\Gamma\)-distribution}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-gamma-as-sum-of-independent-exponentials}{\textbf{Gamma
distribution as a sum of independent exponentials}}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Gamma density curves for alpha 1, 2, 3, and 5 with lambda fixed at 1.}]{assets/notes--fig-prob-02-random-variables-diagram-08.pdf}}

\end{center}

\begin{center}

\pandocbounded{\includegraphics[keepaspectratio,alt={Gamma cumulative distribution curves for alpha 1, 2, 3, and 5 with lambda fixed at 1.}]{assets/notes--fig-prob-02-random-variables-diagram-09.pdf}}
...
\begin{theorem}{\protect\phantomsection\label{kn-de-moivre-laplace-theorem}{\textbf{De
