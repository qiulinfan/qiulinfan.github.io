...
\begin{itemize}
\item
  Let \(E\) be the event that ticket \(1\) is selected at least once. \$\$\textbackslash begin\{align*\} \textbackslash mathbb\{P\}(E) \&= 1 - \textbackslash mathbb\{P\}(\textbackslash text\{ticket \$1\$ is never selected in \$k\$ draws\}) \textbackslash\textbackslash{} \&= 1 - \textbackslash left(\textbackslash frac\{n-1\}\{n\}\textbackslash right)\^{}k \textbackslash tag*\{\textbackslash text\{(by independence of each draw)\}\} \textbackslash end\{align*\}\$\$
\item
...
{∫1𝑦12𝑥2𝑑𝑥=12∫1𝑦𝑥−2𝑑𝑥=12−𝑥−11𝑦=12(1−1𝑦)}
...
This shows that \textbf{\(Y\) is absolutely continuous and \(g\) is a probability density of \(Y\)}. Hence
...
\item
  ...
  {ℙ(𝑋+𝑌\textless0)=∫−10(−𝑥32)𝑑𝑥=−12⋅𝑥44−10=18}
\item
  By def,
...
\item
  ...
  {ℙ(H on first toss)=𝔼{[}𝑝{]}=∫01/2𝑝⋅2𝑑𝑝=2⋅𝑝2201/2=14}
\item
  ...
  {𝔼{[}𝑇{]}=𝔼{[}11−𝑝{]}=∫01/211−𝑝⋅2𝑑𝑝=2−ln(1−𝑝)01/2=2ln2}
\end{itemize}
...
\item
  ...
  {∫02(𝑥2+𝑥𝑦2)𝑑𝑦=2𝑥2+𝑥2⋅𝑦2202=2𝑥2+𝑥}
...
\item
  ...
  {∫0𝑥(𝑥2+𝑥𝑦2)𝑑𝑦=𝑥3+𝑥2⋅𝑦220𝑥=𝑥3+𝑥34=54𝑥3}
...
\item
  ...
  {∫1/22(𝑥2+𝑥𝑦2)𝑑𝑦=𝑥2(2−12)+𝑥2⋅𝑦221/22=32𝑥2+𝑥4(4−14)=32𝑥2+1516𝑥}
...
\section{Problem 1}\label{problem-1-5}
...
\section{Problem 2}\label{problem-2-5}
...
\section{Problem 3}\label{problem-3-5}
...
\section{Problem 4}\label{problem-4-5}
...
\section{Problem 5}\label{problem-5-5}
...
\section{Problem 6}\label{problem-6-5}
...
\section{Problem 1}\label{problem-1-6}
...
\section{Problem 2}\label{problem-2-6}
...
\section{Problem 3}\label{problem-3-6}
...
\section{Problem 4}\label{problem-4-6}
...
\section{Problem 5}\label{problem-5-6}
...
\textbf{Now we claim that: \(A_{n}B_{n}\overset{d}{\rightarrow}Z\).}
