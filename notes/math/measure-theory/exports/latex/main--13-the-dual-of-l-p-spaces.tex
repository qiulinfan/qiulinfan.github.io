...
\begin{definition}{\protect\phantomsection\label{kn-bounded-linear-functional}{\textbf{bounded
linear functional}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-linear-functional-bounded-iff-ctn-at-0}{\textbf{linear
functional bounded \(\Leftrightarrow\) ctn at \(0\)}}}
...
\begin{definition}{\protect\phantomsection\label{kn-dual-space}{\textbf{dual space}}}
...
\begin{definition}{\protect\phantomsection\label{kn-norm-of-dual-space-dual-norm}{\textbf{norm
of dual space: 即 \textbf{dual norm}}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-dual-space-is-always-banach}{\textbf{dual
space is always Banach}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-conjugate-exponent-p-q-l-p-l-q-dual-space}{\textbf{对于互为
conjugate exponent 的 \(p,q\), \(L^{p}\) 是 \(L^{q}\) 的 dual space}}}
