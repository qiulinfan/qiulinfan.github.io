...
\begin{definition}{\protect\phantomsection\label{kn-real-valued-integrable-function}{\textbf{real-valued
integrable function}}}
...
\begin{definition}{\protect\phantomsection\label{kn-complex-valued-integrable-function}{\textbf{complex-valued
integrable function}}}
...
\begin{definition}{\protect\phantomsection\label{kn-tilde-l-x-mu-mathbb-r-tilde-l-x-mu-mathbb-c-space}{\textbf{\(\widetilde{L}(X,\mu,{\mathbb{R}})\)
以及\(\widetilde{L}(X,\mu,{\mathbb{C}})\) space}}}
...
\begin{definition}{\protect\phantomsection\label{kn-integral-restricted-to-a-measurable-set}{\textbf{integral
restricted to a measurable set}}}
...
\begin{definition}{\protect\phantomsection\label{kn-l-1-mu-space}{\textbf{\(L^{1}(\mu)\)
space}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-dominated-convergence-theorem}{\textbf{dominated
convergence theorem}}}
...
\begin{corollary}{\protect\phantomsection\label{kn-fubini-for-series-and-integral}{\textbf{Fubini
for series and integral}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-l-1-mu-integral-w-r-t-mu-norm-normed-vs}{\textbf{\(L^{1}(\mu)\)
以 integral w.r.t. \(\mu\) 作为 norm 是一个 normed VS}}}
...
\begin{corollary}{\protect\phantomsection\label{kn-l-1-mu-cdot-banach-space}{\textbf{\(\left. (L^{1}(\mu), \middle| \middle| \cdot \middle| \middle| ) \right.\)
是一个 Banach space}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-density-of-simple-functions-in-l-1-mu}{\textbf{density
of simple functions in \(L^{1}(\mu)\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-ls-measure-space-l-1-space-density-of-step-functions}{\textbf{LS
measure space 的 \(L^{1}\) space 上的 density of step functions}}}
...
\begin{definition}{\protect\phantomsection\label{kn-c-c-x}{\textbf{\(C_{c}(X)\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-c-c-x-subset-l-1-mu-dense-linear-subspace}{\textbf{\(C_{c}(X) \subset L^{1}(\mu)\)
是一个 dense linear subspace}}}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-015.png}
...
\begin{theorem}{\protect\phantomsection\label{kn-riemann-integral-lebesgue-integral}{\textbf{Riemann
integral 是 Lebesgue integral 的特殊情况}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-lebesgue-s-characterization-of-riemann-integrability}{\textbf{Lebesgue's
...
\begin{definition}{\protect\phantomsection\label{kn-modes-of-convergence-for-functions}{\textbf{modes
of convergence for measurable functions}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-fast-l-1-conv-implies-a-e-conv}{\textbf{\textbf{fast
\(L^{1}\)-conv \(\Longrightarrow\) a.e. conv.}}}}
...
\begin{corollary}{\protect\phantomsection\label{kn-l-1-convergence-impliesconv-in-measure-implies-subseq-a-e-conv}{\textbf{\(L^{1}\)-convergence
(\(\Longrightarrow\)conv. in measure) \(\Longrightarrow\) subseq a.e.
conv.}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-egoroff-s-theorem}{\textbf{Egoroff's
Theorem}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-lusin-s-theorem}{\textbf{Lusin's
Theorem}}}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-016.png}
