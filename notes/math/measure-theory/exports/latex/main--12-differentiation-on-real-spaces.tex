...
\begin{definition}{\protect\phantomsection\label{kn-regular-borel-measure}{\textbf{regular
Borel measure}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-regular-borel-measure-regularity}{\textbf{regular
Borel measure: 蕴含了 regularity}}}
...
\begin{definition}{\protect\phantomsection\label{kn-regular-signed-complex-measure}{\textbf{regular
signed/complex measure}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-ldt-meets-lrnt-computing-rn-derivative-on-mathbb-r-n}{\textbf{LDT
meets LRNT: computing RN derivative on \({\mathbb{R}}^{n}\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-slightly-more-general-version-of-lrnt-meets-ldt}{\textbf{slightly
more general version of LRNT meets LDT}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-monotone-differentiation-theorem}{\textbf{Monotone
...
\begin{definition}{\protect\phantomsection\label{kn-total-variation-function}{\textbf{total
variation function}}}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-034.png}
...
\begin{definition}{\protect\phantomsection\label{kn-function-of-bounded-variation}{\textbf{function
...
\begin{definition}{\protect\phantomsection\label{kn-function-of-bounded-variation-on-an-interval}{\textbf{function
...
\begin{lemma}{\protect\phantomsection\label{kn-bv-complex-vector-space}{\textbf{\(BV\)
是一个 complex vector space}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-f-in-bv-right-ctn-implies-t-f-right-ctn}{\textbf{\(F \in BV\)
right ctn \(\Longrightarrow T_{F}\) right ctn}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-bv-or-bv-i}{\textbf{哪些函数一定 \(BV\)
or \(BV(I)\)}}}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-035.png}
...
\begin{theorem}{\protect\phantomsection\label{kn-jordan-decomposition-for-f-in-bv}{\textbf{Jordan
decomposition for \(F \in BV\)}}}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-036.png}
...
\begin{definition}{\protect\phantomsection\label{kn-nbv}{\textbf{NBV}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-text-complex-borel-measures-on-mathbb-r-simeq-nbv}{\textbf{\(\left\{ {\text{complex Borel measures on}\ {\mathbb{R}}} \right\} \simeq NBV\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-mu-f-total-variation-measure-mu-t-f}{\textbf{\(\mu_{F}\)
的 total variation measure \(=\) \(\mu_{T_{F}}\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-characterization-of-mu-f-perp-m-mu-f-ll-m-for-f-in-nbv}{\textbf{characterization
of \(\mu_{F} \perp m\) 和 \(\mu_{F} \ll m\), for \(F \in NBV\)}}}
...
\begin{definition}{\protect\phantomsection\label{kn-absolutely-continuous-function}{\textbf{absolutely
continuous function}}}
...
\begin{definition}{\protect\phantomsection\label{kn-absolutely-continuous-function-on-a-cpt-interval}{\textbf{absolutely
continuous function on a cpt interval}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-f-in-nbv-abs-ctn-iff-mu-f-ll-m}{\textbf{\(F \in NBV\)
abs ctn \(\Leftrightarrow\) \(\mu_{F} \ll m\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-ftc-ii-for-lebesgue-integral-on-a-cpt-interval}{\textbf{FTC-II
for Lebesgue integral on a cpt interval}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-characterization-for-lipschitz-ctn}{\textbf{characterization
for Lipschitz ctn}}}
