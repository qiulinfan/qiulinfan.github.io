...
\begin{definition}{\protect\phantomsection\label{kn-mathcal-m-mathcal-n-measurable-function}{\textbf{\((\mathcal{M},\mathcal{N})\)-measurable
function}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-composition-preserves-measurability}{\textbf{composition
...
\begin{definition}{\protect\phantomsection\label{kn-real-valued-measurable-functions}{\textbf{(real-valued)
...
\begin{definition}{\protect\phantomsection\label{kn-complex-valued-measurable-functions}{\textbf{(complex-valued)
measurable functions}}}
...
\begin{definition}{\protect\phantomsection\label{kn-lebesgue-measurable-functions-borel-measurable-functions}{\textbf{Lebesgue
measurable functions, Borel measurable functions}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-arithmetic-preserves-measurability}{\textbf{addition
and multiplication preserve measurability}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-sequential-behavior-of-real-valued-measurable-function}{\textbf{sequential
behavior of real-valued measurable function}}}
...
\begin{definition}{\protect\phantomsection\label{kn-characteristic-indicator-function}{\textbf{characteristic
(indicator) function}}}
...
\begin{definition}{\protect\phantomsection\label{kn-simple-function}{\textbf{simple
function}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-a-sum-of-indicator-functions-of-measurable-sets-simple-function}{\textbf{使用
\textbf{a sum of indicator functions of measurable sets} 来定义 simple
function}}}
...
% qlnotes: kind=theorem; id=thm-04-measurable-functions-and-integration-on-l-mu-approximating-a-nonneg-measurable-function-by-simple-function
\begin{theorem}{\protect\phantomsection\label{kn-approximating-a-nonneg-measurable-function-by-simple-function}{\textbf{approximating
a nonneg measurable function by simple function}}}\label{thm-04-measurable-functions-and-integration-on-l-mu-approximating-a-nonneg-measurable-function-by-simple-function}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-013.png}
...
\begin{corollary}{\protect\phantomsection\label{kn-simple-approximation-of-complex-measurable-functions}{\textbf{simple
approximation of complex measurable functions}}}
...
\begin{definition}{\protect\phantomsection\label{kn-l-space-and-integration-on-it}{\textbf{\(L^{+}\)
space and integration on it}}}
...
\begin{definition}{\protect\phantomsection\label{kn-integration-on-a-subset}{\textbf{integration
on a subset}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-integral-of-simple-functions}{\textbf{integral
of simple functions 的性质}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-monotone-convergence-theorem}{\textbf{monotone
convergence theorem}}}
...
\begin{corollary}{\protect\phantomsection\label{kn-tonelli-for-sum-and-integrals}{\textbf{Tonelli
for sum and integrals}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-fatou-lemma}{\textbf{Fatou's Lemma}}}
...
\begin{lemma}{\protect\phantomsection\label{kn-chebyshev-inequality}{\textbf{Chebyshev's
inequality}}}
...
\begin{proposition}{\protect\phantomsection\label{kn-zero-integral-iff-zero-almost-everywhere}{\textbf{非负函数积分为
0 等价于几乎处处为 0}}}
...
\begin{corollary}{\protect\phantomsection\label{kn-liminf-version-of-mct}{\textbf{liminf
version of MCT}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-implies-support-sigma-finite}{\textbf{积分收敛
\(\Longrightarrow\) 发散点集零测, 以及 support \(\sigma\)-finite}}}
