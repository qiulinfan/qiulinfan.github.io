...
\begin{definition}{\protect\phantomsection\label{kn-absolute-continuity-of-signed-measures}{\textbf{absolute
continuity of signed measures}}}

给定 p.m. \(\mu\) 和 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-signed-measure}{signed measure} \(\nu\) on \((X,\mathcal{A})\), 我们称 \(\nu\) is absolutely continuous w.r.t. \(\mu\), 如果
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-033.png}

\end{center}

\href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-mutually-singular}{mutually singular} 的记号 \textbf{\(\nu\bot\mu\) 表示的是 \(\nu\) 和 \(\mu\) 出现变化的区域完全不同}, 而 \textbf{\(\nu \ll \mu\) 表示的是 \(\nu\) 出现变化的区域完全包括在 \(\mu\) 出现变化的区域里} (因为 \(\mu\) 不变化的区域被包括在 \(\nu\) 不变化的区域里).
...
\begin{proposition}{\protect\phantomsection\label{kn-absolutely-continuous}{\textbf{absolutely
continuous 的性质}}}

\begin{itemize}
\item
  对 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-total-variation-measure}{total variation measure},
...
\begin{theorem}{\protect\phantomsection\label{kn-why-it-is-called-absolutely-continuous}{\textbf{why
it is called "absolutely continuous"}}}
...
\begin{definition}{\protect\phantomsection\label{kn-radon-nikodym-derivative}{\textbf{Radon-Nikodym
derivative}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-radon-nikodym-theorem}{\textbf{Radon-Nikodym
Theorem}}}

对于 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-sigma-finite-measure}{\(\sigma\)-finite measure} \(\begin{matrix}
{\{\text{p.m.}\ \mu} \\
{\text{s.m.}\ \nu}
...
考虑 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-hahn-decomposition-theorem}{Hahn Decomposition Theorem} 给出的 \(P_{n} \sqcup N_{n}\) for each \(n\). 并 set:
...
并且根据 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-monotone-convergence-theorem}{monotone convergence theorem}（MCT）,
...
由 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-jordan-decomposition-theorem}{Jordan decomposition theorem} 写出 \(\nu^{+},\nu^{-}\), 再直接 Apply Step 1 即得证.\\
...
\begin{theorem}{\protect\phantomsection\label{kn-lebesgue-radon-nikodym-theorem}{\textbf{Lebesgue-Radon-Nikodym
Theorem}}}
...
\begin{definition}{\protect\phantomsection\label{kn-complex-measure}{\textbf{complex
measure}}}
