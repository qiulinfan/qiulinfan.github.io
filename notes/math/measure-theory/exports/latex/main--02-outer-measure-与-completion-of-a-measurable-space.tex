...
对于 \href{https://qiulinfan.github.io/notes/math/measure-theory/\#kn-measure-space}{measure space} \((X,\mathcal{M},\mu)\), 其中 \(\mu\) 是相应的 \href{https://qiulinfan.github.io/notes/math/measure-theory/\#kn-measure}{measure},
...
\textbf{is a \href{https://qiulinfan.github.io/notes/math/measure-theory/\#kn-sigma-algebra}{\(\sigma\)-algebra}}.\\
...
给定 \(\mathcal{P}(X)\) 上的一个 \href{https://qiulinfan.github.io/notes/math/measure-theory/\#kn-algebra-of-sets}{algebra of sets} \(\mathcal{A}_{0}\), 我们称 \(\mu_{0}:\mathcal{A}_{0}\rightarrow\lbrack 0, + \infty\rbrack\) 为一个 premeasure, if
...
给定一个 premeasure \(\mu_{0}\) on algebra \(\mathcal{M}_{0}\) of \(X\), 以及其 induced outer measure \(\mu \ast\), 我们令 按 \href{https://qiulinfan.github.io/notes/math/measure-theory/\#kn-sigma-algebra-generated-by-a-subset}{\(\sigma\)-algebra generated by a subset} 的定义,
