...
\begin{definition}{\protect\phantomsection\label{kn-nul-set-subnull-set-almost-everywhere}{\textbf{null
set}} , \protect\phantomsection\label{kn-subnull-set}{\textbf{subnull
set}} ,
\protect\phantomsection\label{kn-almost-everywhere}{\textbf{almost
everywhere}}}

对于 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-measure-space}{measure space} \((X,\mathcal{M},\mu)\), 其中 \(\mu\) 是相应的 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-measure}{measure},

\begin{enumerate}
\item
  我们称 \(A \in \mathcal{M}\) 为一个 \textbf{null set}, 如果 \(\mu(A) = 0\);
\item
  我们称 \(B \subseteq X\) 为一个 \textbf{subnull set}, 如果存在某个 null set \(A\) containing it.
\item
...
\begin{definition}{\protect\phantomsection\label{kn-complete-measure-space}{\textbf{complete
measure space}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-every-measure-space-can-be-completed}{\textbf{every
measure space can be completed}}}
...
\begin{definition}{\protect\phantomsection\label{kn-outer-measure}{\textbf{outer measure}}}
...
% qlnotes: kind=theorem; id=thm-02-outer-measure-completion-of-a-measurable-space-construct-outer-measure-out-of-an-elementary-length-function
\begin{theorem}{\protect\phantomsection\label{kn-construct-outer-measure-out-of-an-elementary-length-function}{\textbf{construct
outer measure out of an "elementary length function"}}}\label{thm-02-outer-measure-completion-of-a-measurable-space-construct-outer-measure-out-of-an-elementary-length-function}
...
\begin{definition}{\protect\phantomsection\label{kn-mu-measurable}{\textbf{\(\mu^{\ast}\)-measurable}}}
...
% qlnotes: kind=theorem; id=thm-02-outer-measure-completion-of-a-measurable-space-theorem-003
\begin{theorem}{\protect\phantomsection\label{kn-caratheodory-theorem}{\textbf{Carathéodory
theorem}}}\label{thm-02-outer-measure-completion-of-a-measurable-space-theorem-003}

对于任意的 outer measure \(\mu^{\ast}\),

\[\mathcal{M} := \left\{ {\text{all}\ \mu^{\ast}\ \text{-measurable sets}} \right\}\]

\textbf{is a \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-sigma-algebra}{\(\sigma\)-algebra}}.\\
...
\begin{definition}{\protect\phantomsection\label{kn-premeasure}{\textbf{premeasure}}}

给定 \(\mathcal{P}(X)\) 上的一个 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-algebra-of-sets}{algebra of sets} \(\mathcal{A}_{0}\), 我们称 \(\mu_{0}:\mathcal{A}_{0}\rightarrow\lbrack 0, + \infty\rbrack\) 为一个 premeasure, if
...
% qlnotes: kind=proposition; id=prop-02-outer-measure-completion-of-a-measurable-space-proposition-001
\begin{proposition}{\protect\phantomsection\label{kn-premeasure-extension-via-induced-outer-measure}{\textbf{premeasure
extension via induced outer measure}}}\label{prop-02-outer-measure-completion-of-a-measurable-space-proposition-001}
...
\begin{definition}{\protect\phantomsection\label{kn-sigma-finite-measure}{\textbf{\(\sigma\)-finite
measure}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-hahn-kolmogorov-theorem}{\textbf{Hahn--Kolmogorov
theorem}}}

给定一个 premeasure \(\mu_{0}\) on algebra \(\mathcal{M}_{0}\) of \(X\), 以及其 induced outer measure \(\mu \ast\), 我们令 按 \href{https://qiulinfan.github.io/qlblog/notes/math/measure-theory/\#kn-sigma-algebra-generated-by-a-subset}{\(\sigma\)-algebra generated by a subset} 的定义,
