...
\begin{definition}{\protect\phantomsection\label{kn-distribution-function-of-mu}{\textbf{distribution
function of \(\mu\)}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-distribution-function-is-increasing-and-right-ctn}{\textbf{distribution
function is increasing and right ctn}}}
...
\begin{definition}{\protect\phantomsection\label{kn-h-interval}{\textbf{h-interval}}}
...
\includegraphics[width=0.2\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-006.png}

\end{center}

\begin{lemma}{\protect\phantomsection\label{kn-h-intervals-form-an-algebra-and-generate-borel-set}{\textbf{h-intervals
form an algebra and generate borel set}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-increasing-right-ctn-regular-borel-measure-distribution}{\textbf{\textbf{任意
increasing 且 right ctn 函数都是某个 regular Borel measure 的
distribution 函数}}}}
...
\includegraphics[width=0.2\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-007.png}
...
\begin{definition}{\protect\phantomsection\label{kn-lebesgue-stieltjes-measure-associated-with-f}{\textbf{Lebesgue-Stieltjes
...
\begin{lemma}{\protect\phantomsection\label{kn-open-interval-covers-for-lebesgue-stieltjes-measure}{\textbf{open-interval
covers for Lebesgue--Stieltjes measure}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-outer-regularity}{\textbf{\textbf{outer
regularity}}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-inner-regularity}{\textbf{\textbf{inner
regularity}}}}
...
\includegraphics[width=0.4\linewidth,height=\textheight,keepaspectratio]{assets/main--figure-raster-008.png}
...
\begin{definition}{\protect\phantomsection\label{kn-g-delta-f-sigma-sets}{\textbf{\(G_{\delta},F_{\sigma}\)
sets}}}
...
% qlnotes: kind=theorem; id=thm-03-distribution-function-lebesgue-stieltjes-measures-lebesgue-stieltjes-measurable
\begin{theorem}{\protect\phantomsection\label{kn-lebesgue-stieltjes-measurable}{\textbf{Lebesgue-Stieltjes
measurable 的等价条件}}}\label{thm-03-distribution-function-lebesgue-stieltjes-measures-lebesgue-stieltjes-measurable}
...
\begin{definition}{\protect\phantomsection\label{kn-lebesgue-measure}{\textbf{Lebesgue
measure}}}
...
\begin{theorem}{\protect\phantomsection\label{kn-mathcal-l-preserves-translation-and-scaling}{\textbf{\(\mathcal{L}\)
preserves translation and scaling}}}
