...
::: {#def-01-sigma-algebra-measure-algera-sigma-algebra .definition concepts="algera-sigma-algebra" aliases="algera, \\sigma-algebra"}
**Definition: algera, \\sigma-algebra**
...
如果第三条并不满足, 而是只满足 **closed under finite union**, 则称 $S$ 是 $X$ 上的一个 algebra. 当然, $\sigma$-algebra 是比 algebra 严格更强的条件.
:::
...
::: {#thm-01-sigma-algebra-measure-sigma-algebra-also-closed-under-set-difference-symmetric-differe .theorem concepts="sigma-algebra-also-closed-under-set-difference-symmetric-differe" aliases="\\sigma-algebra also closed under set difference, symmetric difference and countable intersection"}
**Theorem: \\sigma-algebra also closed under set difference, symmetric difference and countable intersection**
...
::: {#lem-01-sigma-algebra-measure-sigma-algebra-intersection-sigma-algebra .lemma concepts="sigma-algebra-intersection-sigma-algebra" aliases="任意 \\sigma-algebra 的 intersection 仍是 \\sigma-algebra"}
...
::: {#cor-01-sigma-algebra-measure-unique-smallest-sigma-algebra-containing-a-collection-of-subsets .corollary concepts="unique-smallest-sigma-algebra-containing-a-collection-of-subsets" aliases="unique smallest \\sigma-algebra containing a collection of subsets"}
...
::: {#def-01-sigma-algebra-measure-sigma-algebra-generated-by-a-subset .definition concepts="sigma-algebra-generated-by-a-subset" aliases="\\sigma-algebra generated by a subset"}
...
::: {#ex-01-sigma-algebra-measure-example-001 .example concepts="example-001"}
**Example**

$$< \left\{ E \right\} > = \left\{ {\varnothing,E,E^{c},X} \right\}$$
:::

::: {#lem-01-sigma-algebra-measure-inclusion-properties-of-generated-sigma-algebra .lemma concepts="inclusion-properties-of-generated-sigma-algebra" aliases="inclusion properties of generated \\sigma-algebra"}
...
::: {#def-01-sigma-algebra-measure-borel-sigma-algebra-defined-on-a-topological-space .definition concepts="borel-sigma-algebra-defined-on-a-topological-space" aliases="Borel \\sigma-algebra defined on a topological space"}
...
:::: {#ex-01-sigma-algebra-measure-example-002 .example concepts="example-002"}
**Example**
...
::: {#lem-01-sigma-algebra-measure-lemma-003 .lemma concepts="lemma-003"}
**Lemma**
...
::: {#def-01-sigma-algebra-measure-measurable-space-and-measure-space .definition concepts="measurable-space-and-measure-space" aliases="measurable space and measure space"}
...
::: {#ex-01-sigma-algebra-measure-example-003 .example concepts="example-003"}
**Example**
...
::: {#lem-01-sigma-algebra-measure-measure-is-finitely-additive .lemma concepts="measure-is-finitely-additive" aliases="measure is finitely additive"}
...
::: {#lem-01-sigma-algebra-measure-lemma-005 .lemma concepts="lemma-005"}
**Lemma**
...
::: {#cor-01-sigma-algebra-measure-corollary-002 .corollary concepts="corollary-002"}
**Corollary**
...
::: {#thm-01-sigma-algebra-measure-properties-of-measure .theorem concepts="properties-of-measure" aliases="properties of measure"}
...
::: {#lem-01-sigma-algebra-measure-measure-is-finitely-additive-2 .lemma concepts="measure-is-finitely-additive" aliases="measure is finitely additive"}
**Lemma: measure is finitely additive**
...
::: {#lem-01-sigma-algebra-measure-lemma-007 .lemma concepts="lemma-007"}
**Lemma**
...
::: {#cor-01-sigma-algebra-measure-corollary-003 .corollary concepts="corollary-003"}
**Corollary**
...
::: {#thm-01-sigma-algebra-measure-properties-of-measure-2 .theorem concepts="properties-of-measure" aliases="properties of measure"}
**Theorem: properties of measure**
...
![Figure 1:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-001.png){width="20%"}
...
![Figure 2:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-002.png){width="20%"}
...
![Figure 3:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-003.jpg){width="80%"}
...
![Figure 4:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-004.png){width="70%"}

![Figure 5:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-005.png){width="70%"}
:::
...
![Figure 6:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-006.png){width="20%"}
...
![Figure 7:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-007.png){width="20%"}
...
![Figure 8:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-008.png){width="40%"}
...
![Figure 9:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-009.png){width="65%"}

![Figure 10:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-010.png){width="70%"}
:::
...
![Figure 11:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-011.png){width="25%"}
:::
...
![Figure 12:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-012.png){width="70%"}
:::
...
![Figure 13:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-013.png){width="60%"}
:::
...
![Figure 14:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-014.png){width="35%"}
...
![Figure 15:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-015.png){width="60%"}
...
![Figure 16:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-016.png){width="85%"}
...
![Figure 17:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-017.png){width="30%"}
...
![Figure 18:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-018.png){width="30%"}
...
![Figure 19:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-019.png){width="30%"}
:::
...
![Figure 20:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-020.png){width="40%"}
...
![Figure 21:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-021.png){width="40%"}
...
![Figure 22:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-022.png){width="40%"}
...
![Figure 23:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-023.png){width="30%"}
...
![Figure 24:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-024.png){width="40%"}
...
![Figure 25:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-025.png){width="40%"}
...
![Figure 26:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-026.png){width="30%"}
...
![Figure 27:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-027.png){width="30%"}
...
![Figure 28:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-025.png){width="40%"}
...
![Figure 29:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-028.png){width="40%"}
...
![Figure 30:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-029.png){width="28%"}
...
![Figure 31:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-030.png){width="45%"}
:::
...
![Figure 32:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-031.png){width="24%"}
...
![Figure 33:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-032.png){width="35%"}
...
![Figure 34:[ ]{style="white-space: pre-wrap"}mutually singular and absolutely continuous](main.assets/figure-raster-033.png){width="50%"}
...
![Figure 35:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-034.png){width="50%"}
:::
...
![Figure 36:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-035.png){width="50%"}
:::
...
![Figure 37:[ ]{style="white-space: pre-wrap"}positive/negative variation](main.assets/figure-raster-036.png){width="50%"}
...
![Figure 38:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-024.png){width="40%"}
...
![Figure 39:[ ]{style="white-space: pre-wrap"}](main.assets/figure-raster-037.png){width="30%"}
...
![Figure 40:[ ]{style="white-space: pre-wrap"}unbounded total variation by alternating limsup/inf seq](main.assets/figure-raster-038.png){width="50%"}
