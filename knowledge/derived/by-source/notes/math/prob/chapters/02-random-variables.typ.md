...
kgd_source: "notes/math/prob/chapters/02-random-variables.typ"
kgd_source_format: "typst"
kgd_source_sha256: "ae29178c950e3a9bf05dbd5e81414c3c9b17705260ce8b01363a50b28f1f7e4f"
---
...
semantic-node-count: 38
source: "notes/math/prob/chapters/02-random-variables.typ"
...
> 因而:
>
> > **Corollary: --[[distribution function $F_{X}$ determines distribution ${\mathbb{P}}^{X}$]]--**
> >
...
> **Proposition: --[[pmf 是 distribution 对于 counting measure $\mu_{S}$ 的 Radon-Nikodym 导数]]--**
>
...
> **Definition: --[[zero-centered square integrable random variables $L_{0}^{2}(\Omega,\mathcal{F},{\mathbb{P}})$]]--**
>
> 我们定义:
>
> $$
...
> **Theorem: --[[covariance is a positive-semidefinite symmetric bilinear form]]--**
>
...
> **Theorem: --[[$L_{0}^{2}(\Omega,\mathcal{F},{\mathbb{P}})$ 为一个 Hilbert space, with covariance as an inner product]]--**
>
...
> **Proposition: --[[Gamma distribution as a sum of independent exponentials]]--**
>
